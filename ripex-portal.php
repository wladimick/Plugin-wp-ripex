...
define('RIPEX_PORTAL_VERSION', '1.5.15');
define('RIPEX_PORTAL_PATH', plugin_dir_path(__FILE__));
define('RIPEX_PORTAL_URL', plugin_dir_url(__FILE__));

// Phase 08 is intentionally loaded first so an explicitly enabled staging
// capture sees the RIPEX request from plugin bootstrap onward. It is a no-op
// unless RIPEX_PORTAL_OBSERVABILITY is true.
